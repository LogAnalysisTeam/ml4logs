...
if __name__ == '__main__':
    ...
    ict_datasets_basepath = Path('/home/cernypro/dev/source/ml4logs/data/processed/Combined_20210401_train_only_target_flat_context')
    ...
    ict_datasets_full_paths = [
        (Path('/home/cernypro/dev/source/ml4logs/data/processed/train-data-HDFS1-cv1-1_Epochs-4_Seed-43'), 'M_basic_chunked_10'),
        (Path('/home/cernypro/dev/source/ml4logs/data/processed/train-data-HDFS1-cv1-1-time-ordered_Epochs-4_Seed-43'), 'M_time_ordered_chunked_10')
    ]
    ...
    for dataset_path, dataset_run_name in ict_datasets_full_paths:
        for two_tower in [False, True]:
            ...
            encoder_type = 'DistilbertLastNCls'
            bert_model = 'distilbert-base-cased'
            # encoder_type = 'RobertaLastNCls'
            ...
            ict_job_num = run_train_ict_from_preprocessed(two_tower=two_tower,
                                                        ...
                                                        dataset_run_name=dataset_run_name,
                                                        dataset_path=dataset_path,
                                                        eval_dataset_path='/home/cernypro/dev/source/ml4logs/data/processed/val-data-HDFS1-cv1-1-time-ordered_chunked-10_distilbert',
                                                        output_encode_dim=output_encode_dim,
                                                        train_batch_size=train_batch_size,
                                                        target_max_seq_len=target_max_seq_len,
                                                        eval_steps=7500,
