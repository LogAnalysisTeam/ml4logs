...
def main():
    ...
    parser.add_argument('--remove-hdfs1-timestamp', default=False, action='store_true', help="Remove timestamps in HDFS1 format")
    parser.add_argument("--threads", default=1, type=int, help="Only used when removing HDFS1 timestamps")
